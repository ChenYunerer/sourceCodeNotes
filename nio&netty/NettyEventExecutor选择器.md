...
具体构建哪种由EventExecutorChooserFactory来进行构建，EventExecutorChooserFactory的实现类为：DefaultEventExecutorChooserFactory，它根据EventExecutor数量是否为2的N次幂函来决定具体构建哪种，如果是2的N次幂则使用PowerOfTwoEventExecutorChooser否则GenericEventExecutorChooser
